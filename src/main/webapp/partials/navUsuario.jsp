...
<div class="container">
	<nav class="navbar navbar-expand-lg navbar-dark">
		...
		<h1 class="text-uppercase text-white m-0 nav-title">Turismo en
			Tierra Media</h1>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link active"
					...
					Atracciones</a>
					<%-- href="#novedades">Atracciones</a></li>--%>
				<li class="nav-item"><a class="nav-link active"
					href="#recomendamos">Recomendamos</a></li>
				<li class="nav-item"><a class="nav-link active"
					href="#contacto">Contacto</a></li>
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="/tierraMedia/login.jsp">
					Login</a></li>
			</ul>
		</div>
