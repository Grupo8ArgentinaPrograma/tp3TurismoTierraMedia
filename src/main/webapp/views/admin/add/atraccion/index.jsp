...
<body class="text-white bg-dark">
	...
	<form action="/tierraMedia/admin/add/atraccion/index.ad" method="post">
		...
		<div class="form-group mb-3">
			<label for="costo">Costo:</label> <input class="form-control"
				id="number" type="number" name="costo" required/>
		</div>
		<div class="form-group mb-3">
		...
		<div class="form-group mb-3">
			<label for="nombre">Tipo de atracción: </label> <select
